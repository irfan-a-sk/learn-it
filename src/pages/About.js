...
const About =() => {
    return(
        ...
        <div className="App m-auto ">
            <h1 className='Heading text-center mt-[30px] text-[40px]'><strong>Innovation </strong>in Online Learning
            </h1><br></br>
          </div>
         
          <div className="main w-[1000px] h-[950px] block m-[auto]  relative md:w-[700px] md:h-[550px]">
            <img src={sky} alt='blue-bg' className='absolute w-full h-[600px] -z-10 bottom-[2%] right-[12%] max-lg:right-[0%]' />
          <div className="grid-container flex text-[white] ">
            <div>
            <img src={Girl1} className="img1 "width="670px"  alt='girl-img' />
            </div>
            <div className="text max-w-[350px] h-[205px] p-[20px] bg-slate-900 w-[300px] md:h-[170px]">
              <h3>Mordern <strong>Education</strong> </h3>
              <p>dfdkjd  dfkjkfdfkdjsdn dsfjshnvs sdisvjsdijvs sdivsdi
              </p>
            </div>
            <img src={Wheel} className="img2 w-[300px] h-[205px] md:h-[170px]" alt='wheel-img' />
            </div>
            <div className="grid2 flex">
              <div className="girl2">
            <img src={Girl2} className="img3 w-[540px] h-[205px] md:h-[160px] md:w-[200px]" alt='girl-2' />
            </div>
            <div className="text p-[20px] bg-slate-900 w-[230px] h-[205px] text-[white] md:h-[160px] md:w-[200px]">
              <h3>Mordern <strong>Education</strong></h3>
              <p>dfdkjd  dfkjkfdfkdjsdn dsfjshnvs sdisvjsdijvs sdivsdi
              </p>
            </div>
            <div className="desk ">
            <img src={Desk} className="img4 w-[432px] h-[345px] object-cover mt-[-32.3%] ml-[0.01%] md:w-[385px] md:h-[270px] " alt='desk-img' />
            </div>
            </div>
            </div>
    
    
            <div className="Container-2 relative mb-[40px]">
              <div className="halfCircle rounded-br-[750px] rounded-bl-[750px] m-[auto] mt-[0px] mb-[60px] w-[850px] h-[400px] bg-[#89D0CA] text-center md:w-[700px] md:rounded-br-[650px] md:rounded-bl-[650px] md:h-[340px]  ">
              ...
              <div className="card flex flex-wrap gap-[20px] justify-center mt-[-300px] md:mt-[-250px] ">
                <div className="Card1 p-[20px] w-[300px] bg-[#D6D6D6] md:w-[170px] lg:w-[250px]">
                ...
                <div className="Card2 p-[20px]  bg-[#D6D6D6] md:w-[170px] lg:w-[250px]">
                ...
                <div className="Card3 p-[20px]  bg-[#D6D6D6] md:w-[170px] lg:w-[250px]">
                ...
                <div className="Card4 p-[20px]  bg-[#D6D6D6] md:w-[170px] lg:w-[250px]  ">
                  <div className="cardCirc ml-[20px] w-[90px] h-[90px] rounded-[50%] bg-[#71b9b3] text-[white] text-center md:w-[60px] md:h-[60px] ">
